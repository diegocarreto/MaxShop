...
{
    public partial class LocationEdit : FormBase
    {
        #region Members
        ...
        public LocationEdit(int? Id = null)
        {
            InitializeComponent();
        ...
        private void btnAccept_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txtName.Text))
            {
                ...
                this.Alert("Debe indicar la ubicacion");
        }
        ...
        {
            using (posb.Location Entity = new posb.Location
            {
                Id = this.Id
            })
            {
        ...
        private void Save(bool Exist = true)
        {
            ...
            })
            {
                if (Exist && Entity.Exist())
                    this.Alert("Ya se encuentra registrada la ubicacion [" + Entity.Name + "]");
                else
                {
                    Entity.Save();
