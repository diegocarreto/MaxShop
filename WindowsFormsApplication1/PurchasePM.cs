...
{
    public partial class PurchasePM : FormBase
    {
        #region Members
        ...
        private posb.Purchase Entity { get; set; }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //        List<PosBusiness.Purchase> lSale = this.Entity.List(this.dtpDate1.Value, this.dtpDate2.Value);
            ...
            //        foreach (PosBusiness.Purchase sale in lSale)
            //        {
            //            if (sale.ForReport)
            //            {
