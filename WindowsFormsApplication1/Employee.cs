...
{
    public partial class Employee : FormBase
    {
        #region Properties

        private posb.Employee Entity { get; set; }
        ...
        {
            if (this.Confirm("¿Realmente deseas eliminar al empleado [" + this.EntityName + "]?"))
            {
                ...
                if (this.Entity.Delete())
                {
                    ...
                    this.Alert("Ocurrió un error al intentar eliminar al empleado [" + this.EntityName + "]", eForm.TypeError.Error);
            }
        }
        ...
        {
            EmployeeEdit EmployeeEdit = new EmployeeEdit(Id);

            EmployeeEdit.Result += new EmployeeEdit.Communication(Result);
