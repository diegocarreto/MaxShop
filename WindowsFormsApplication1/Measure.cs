...
{
    public partial class Measure : FormBase
    {
        #region Properties

        private posb.Measure Entity { get; set; }
        ...
        private void OpenEdit(int? Id = null)
        {
            ...
            MeasureEdit.Result += new MeasureEdit.Communication(Result);
