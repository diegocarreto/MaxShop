...
namespace WindowsFormsApplication1
{
    public partial class Income : FormBase
    {
        ...
        {
            if (this.Confirm("¿Realmente deseas eliminar el ingreso [" + this.EntityName + "]?"))
            {
                ...
                if (this.Entity.Delete())
                {
                    ...
                    this.Alert("Ocurrió un error al intentar eliminar el ingreso [" + this.EntityName + "]", eForm.TypeError.Error);
            }
        }
        ...
        {
            svdReportStock.FileName = "Ingresos_" + DateTime.Now.ToString("ddMMyyyyhhmmss");
            ...
            if (total.Equals(0))
            {
                this.Alert("Debe seleccionar al menos un ingreso");
            ...
            if (svdReportStock.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    List<PosBusiness.Income> lSale = this.Entity.List();
                    ...
                    foreach (PosBusiness.Income expense in lSale)
                    {
        ...
        {
            IncomeEdit IncomeEdit = new IncomeEdit(Id);

            IncomeEdit.Result += new IncomeEdit.Communication(Result);

            IncomeEdit.ShowDialog();
        }
        ...
        private void FillGridView()
        {
            ...
            List<posb.Income> lExpenses = this.Entity.List();
