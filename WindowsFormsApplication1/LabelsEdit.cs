...
{
    public partial class LabelsEdit : FormBase
    {
        #region Members
        ...
        private void btnAccept_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txtName.Text))
            {
                ...
                this.Alert("Debe indicar el nombre de la etiqueta");
        }
        ...
        {
            using (posb.Label Entity = new posb.Label
            {
                Id = this.Id
            })
            {
        ...
        private void Save(bool Exist = true)
        {
            ...
            })
            {
                if (Exist && Entity.Exist())
                    this.Alert("Ya se encuentra registrada la etiqueta [" + Entity.Name + "]");
                else
                {
                    Entity.Save();
