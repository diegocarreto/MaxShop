namespace DataAccess.MsSqlCommands.Pos
{
	...
	/// <summary>
	/// Controla la ejecucion del procedimientos almacenados SpDropdiagram.
	/// </summary>
	public partial class SpDropdiagram : AccessMsSQL
	{
        #region Methods
        ...
        public List<T> ExeList<T>(String diagramname = null, int? owner_id = null) where T : new()
        {
        	...
        	return this.GetListBase<T>("pos", "sp_dropdiagram",parameters.ToArray());
        }
        ...
        public T ExeScalar<T>(String diagramname = null, int? owner_id = null)
        {
        	...
        	return this.ExecuteScalar<T>("pos", "sp_dropdiagram",parameters.ToArray());
        }
        ...
        public int ExeNonQuery(String diagramname = null, int? owner_id = null)
        {
        	...
        	return this.ExecuteNonQuery("pos", "sp_dropdiagram",parameters.ToArray());
        }
        ...
        public IDataReader ExeReader(String diagramname = null, int? owner_id = null)
        {
        	...
        	return this.GetReader("pos", "sp_dropdiagram",parameters.ToArray());
        }
