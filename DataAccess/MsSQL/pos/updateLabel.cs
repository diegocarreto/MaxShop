namespace DataAccess.MsSqlCommands.Pos
{
	...
	/// <summary>
	/// Controla la ejecucion del procedimientos almacenados Updatelabel.
	/// </summary>
	public partial class Updatelabel : AccessMsSQL
	{
        #region Methods
        ...
        public List<T> ExeList<T>(int? id = null, String name = null, Boolean? active = null) where T : new()
        {
        	...
        	return this.GetListBase<T>("pos", "updateLabel",parameters.ToArray());
        }
        ...
        public T ExeScalar<T>(int? id = null, String name = null, Boolean? active = null)
        {
        	...
        	return this.ExecuteScalar<T>("pos", "updateLabel",parameters.ToArray());
        }
        ...
        public int ExeNonQuery(int? id = null, String name = null, Boolean? active = null)
        {
        	...
        	return this.ExecuteNonQuery("pos", "updateLabel",parameters.ToArray());
        }
        ...
        public IDataReader ExeReader(int? id = null, String name = null, Boolean? active = null)
        {
        	...
        	return this.GetReader("pos", "updateLabel",parameters.ToArray());
        }
