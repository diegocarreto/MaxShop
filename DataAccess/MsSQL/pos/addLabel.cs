namespace DataAccess.MsSqlCommands.Pos
{
	...
	/// <summary>
	/// Controla la ejecucion del procedimientos almacenados Addlabel.
	/// </summary>
	public partial class Addlabel : AccessMsSQL
	{
        #region Methods
        ...
        public List<T> ExeList<T>(String name = null, Boolean? active = null) where T : new()
        {
        	...
        	return this.GetListBase<T>("pos", "addLabel",parameters.ToArray());
        }
        ...
        public T ExeScalar<T>(String name = null, Boolean? active = null)
        {
        	...
        	return this.ExecuteScalar<T>("pos", "addLabel",parameters.ToArray());
        }
        ...
        public int ExeNonQuery(String name = null, Boolean? active = null)
        {
        	...
        	return this.ExecuteNonQuery("pos", "addLabel",parameters.ToArray());
        }
        ...
        public IDataReader ExeReader(String name = null, Boolean? active = null)
        {
        	...
        	return this.GetReader("pos", "addLabel",parameters.ToArray());
        }
