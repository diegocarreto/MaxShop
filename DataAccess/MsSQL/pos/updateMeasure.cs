namespace DataAccess.MsSqlCommands.Pos
{
	...
	/// <summary>
	/// Controla la ejecucion del procedimientos almacenados Updatemeasure.
	/// </summary>
	public partial class Updatemeasure : AccessMsSQL
	{
        #region Methods
        ...
        public List<T> ExeList<T>(int? id = null, String name = null, Boolean? active = null) where T : new()
        {
        	...
        	return this.GetListBase<T>("pos", "updateMeasure",parameters.ToArray());
        }
        ...
        public T ExeScalar<T>(int? id = null, String name = null, Boolean? active = null)
        {
        	...
        	return this.ExecuteScalar<T>("pos", "updateMeasure",parameters.ToArray());
        }
        ...
        public int ExeNonQuery(int? id = null, String name = null, Boolean? active = null)
        {
        	...
        	return this.ExecuteNonQuery("pos", "updateMeasure",parameters.ToArray());
        }
        ...
        public IDataReader ExeReader(int? id = null, String name = null, Boolean? active = null)
        {
        	...
        	return this.GetReader("pos", "updateMeasure",parameters.ToArray());
        }
