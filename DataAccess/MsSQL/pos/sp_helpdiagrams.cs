namespace DataAccess.MsSqlCommands.Pos
{
	...
	/// <summary>
	/// Controla la ejecucion del procedimientos almacenados SpHelpdiagrams.
	/// </summary>
	public partial class SpHelpdiagrams : AccessMsSQL
	{
        #region Methods
        ...
        public List<T> ExeList<T>(String diagramname = null, int? owner_id = null) where T : new()
        {
        	...
        	return this.GetListBase<T>("pos", "sp_helpdiagrams",parameters.ToArray());
        }
        ...
        public T ExeScalar<T>(String diagramname = null, int? owner_id = null)
        {
        	...
        	return this.ExecuteScalar<T>("pos", "sp_helpdiagrams",parameters.ToArray());
        }
        ...
        public int ExeNonQuery(String diagramname = null, int? owner_id = null)
        {
        	...
        	return this.ExecuteNonQuery("pos", "sp_helpdiagrams",parameters.ToArray());
        }
        ...
        public IDataReader ExeReader(String diagramname = null, int? owner_id = null)
        {
        	...
        	return this.GetReader("pos", "sp_helpdiagrams",parameters.ToArray());
        }
